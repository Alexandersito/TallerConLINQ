...
namespace AplicativoConLINQ
{
    ...
    partial void DeleteVendedor(Vendedor instance);
		...
		public VentasDataContext() : 
				base(global::AplicativoConLINQ.Properties.Settings.Default.BDVentasConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnPrecioUnitarioChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TProducto_TDetalle", Storage="_Producto", ThisKey="CodProducto", OtherKey="CodProducto", IsForeignKey=true)]
    ...
    partial void OnCodCategoriaChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TProducto_TDetalle", Storage="_Detalle", ThisKey="CodProducto", OtherKey="CodProducto")]
		public EntitySet<Detalle> Detalle
		{
			get
			{
